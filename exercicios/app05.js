...
let oTalDoId = Number(read.question("Informe um numero: "));

const livroAchado = acharPorId(oTalDoId);
if(livroAchado){
...
console.log("id (number): identificador do filme. titulo (string): título do filme. diretor (string): nome do diretor. anoLancamento (number): ano de lançamento do filme.\n".cyan); 
...
const precoMaximo = filtrarOrdenarProdutosPorPreco(quantoVoceTem);
console.log("Temos estas opçoes: ", precoMaximo);
...
let vcEstaProcurandoQualFuncionario = Number(read.question("Qual funcionario voce esta a procura?: "))

const funcionarioEncontrado = encontrarFuncionarioPorId(vcEstaProcurandoQualFuncionario);
